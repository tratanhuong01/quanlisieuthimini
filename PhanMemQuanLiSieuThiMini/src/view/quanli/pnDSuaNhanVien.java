...
public class pnDSuaNhanVien extends javax.swing.JDialog {
    public pnDSuaNhanVien(java.awt.Frame parent, boolean modal,NhanVien nv,pnMain pnM,JPanel pnBanHang,JMenuItem pnSua) {
        super(parent, modal);
        initComponents();
    }
