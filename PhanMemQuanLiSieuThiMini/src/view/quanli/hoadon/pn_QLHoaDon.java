...
public class pn_QLHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listHoaDon.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
    ...
    private void listHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listHoaDonMouseClicked
        int row = listHoaDon.getSelectedRow();
        txtTenKhachHang.setText(listHoaDon.getModel().getValueAt(row, 0).toString());
        txtMaHoaDon.setText(listHoaDon.getModel().getValueAt(row, 2).toString());
        txttMaKhachHang.setText(listHoaDon.getModel().getValueAt(row, 4).toString());
