...
public class pn_NhomSanPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(530, 100, 110, 50);

        jButton2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jButton2.setText("Sửa");
        jPanel1.add(jButton2);
        jButton2.setBounds(530, 190, 110, 50);

        jButton3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jButton3.setText("Thêm");
        jPanel1.add(jButton3);
        jButton3.setBounds(530, 10, 110, 50);
        ...
        jTextField1.setBounds(210, 10, 300, 50);

        jTextField2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jPanel1.add(jTextField2);
        jTextField2.setBounds(210, 70, 300, 50);
        ...
        jTextField3.setBounds(210, 130, 300, 50);
        ...
        jTextField4.setBounds(210, 190, 300, 50);
