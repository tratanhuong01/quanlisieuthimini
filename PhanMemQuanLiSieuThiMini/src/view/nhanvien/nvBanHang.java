...
public class nvBanHang extends javax.swing.JFrame {
    NhanVien nvs;
    ...
    public nvBanHang() {
        ...
        pnBanHang.removeAll();
        pnMain pnM = new pnMain(pnBanHang);
        pnM.setVisible(true);
    ...
    private void initComponents() {
        ...
        pnThemKhachHang1.setText("Sửa Khách Hàng");
    ...
    private void pnThemKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pnThemKhachHangActionPerformed
        nvBanHang nv = new nvBanHang(nvs);
